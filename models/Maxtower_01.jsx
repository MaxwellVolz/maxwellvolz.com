  ...
  return (
    <group {...props} dispose={null}>
      <group scale={0.03}>
        <group position={[-110.17, 246, -2]}>
          <group position={[80.07, 0.5, -5.76]}>
            <group position={[6.1, 26.81, -11.98]}>
              <group position={[7.37, 2.76, 0]} rotation={[0, 0, -2.99]} scale={1.66}>
                ...
                <group position={[0, 0.25, 0]}>
                  <mesh geometry={nodes.ID101001.geometry} material={materials.Color_M06} />
                  <mesh geometry={nodes.ID101001_1.geometry} material={materials.Chris_Shoe_Sole} />
                </group>
              ...
              <mesh geometry={nodes.group_13.geometry} material={materials['Color_M07.001']} position={[1.97, 1.54, -19.27]} scale={1.66} />
            ...
            <group position={[2.35, 18, 0]} rotation={[-Math.PI, -1.57, 0]}>
              <mesh geometry={nodes.group_3.geometry} material={materials['material.002']} position={[0, -8.81, 0]} />
              <mesh geometry={nodes.group_4.geometry} material={materials['material.002']} position={[1, 2, -1]} />
              <mesh geometry={nodes.group_5.geometry} material={materials['material.002']} position={[45, 2, -1]} />
              <mesh geometry={nodes.group_6.geometry} material={materials['material.002']} position={[45, 2, -21]} />
              <mesh geometry={nodes.group_7.geometry} material={materials['material.002']} position={[1, 2, -21]} />
            </group>
            ...
            <group position={[21.55, 26.81, -35.9]} rotation={[0, -1.57, 0]} scale={0.7}>
              ...
              <group position={[15, 3.21, 1.05]} rotation={[-0.11, 0, 0]}>
                <mesh geometry={nodes.ID67001.geometry} material={materials.Color_M06} />
                <mesh geometry={nodes.ID67001_1.geometry} material={materials.Color_M09} />
              </group>
          ...
          <group position={[108.66, 0, -88.65]} rotation={[-Math.PI, 1.48, -Math.PI]}>
            <mesh geometry={nodes.group_26.geometry} material={materials['noon_2.001']} />
            <mesh geometry={nodes.group_27.geometry} material={materials.noon_3} position={[3, 15.81, -0.35]} rotation={[-1.49, 0, 0]} />
            <mesh geometry={nodes.group_27001.geometry} material={materials['material.002']} position={[3, 15.81, -0.35]} rotation={[-1.49, 0, 0]} />
          ...
          <group position={[0, 0, -3.57]}>
            ...
            <mesh geometry={nodes.group_34.geometry} material={materials['Color_M08.001']} position={[4.75, 30.81, -3.86]} />
            <mesh geometry={nodes.group_34001.geometry} material={materials['Color_M08.001']} position={[4.75, 30.81, -3.86]} />
            ...
            <group position={[4.75, 31.81, -3.86]}>
              ...
              <mesh geometry={nodes.ID350_1.geometry} material={materials['noon_5.001']} />
            </group>
            ...
            <mesh geometry={nodes.group_37.geometry} material={materials['material.002']} position={[19.4, 31.06, -19.3]} />
          </group>
          <mesh geometry={nodes.group_24.geometry} material={materials['noon_5.001']} position={[31.42, 0, 0]} />
          <mesh geometry={nodes.group_38.geometry} material={materials['material.002']} position={[-3.83, 25.69, -30.97]} />
        </group>
        ...
        <mesh geometry={nodes.group_39.geometry} material={materials['material.002']} position={[-68.5, 283.36, -115]} />
        <mesh geometry={nodes.group_41.geometry} material={materials.noon1} position={[-114, 246, -110]} />
        <mesh geometry={nodes.image_0.geometry} material={materials['material.002']} position={[-68.5, 283.36, -114.8]} rotation={[Math.PI / 2, 0, 0]} scale={[0.04, 1, 0.04]} />
      </group>
    </group>
  )
}
